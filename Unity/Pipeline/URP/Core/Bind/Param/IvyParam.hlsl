...
//float3 世界空间中的相机位置。
#define IvyParam_CameraPosWs _WorldSpaceCameraPos 
//float4 投影参数
#define IvyParam_ProjectionParams _ProjectionParams
//float4 屏幕参数
#define IvyParam_ScreenParams _ScreenParams
//float4 Z缓存参数
#define IvyParam_ZBufferParams _ZBufferParams
//float4 正交参数
#define IvyParam_OrthoParams unity_OrthoParams
//float4 相机投影参数
...
#define IvyParam_AmbientSky unity_AmbientSky
//float4 赤道环境光颜色（RGB）和强度（A）
#define IvyParam_AmbientEquator unity_AmbientEquator
//float4 地面环境光颜色（RGB）和强度（A）
#define IvyParam_AmbientGround unity_AmbientGround
//float4 主光源位置/方向（世界空间）。xyz:位置/方向，w:0=方向光，1=点光源
#define IvyParam_WorldSpaceLightPos _WorldSpaceLightPos0
//float4 主光源颜色（RGB）和强度（A）
#define IvyParam_LightColor _LightColor0

//===[球谐光照]===

//float4 球谐函数 R 通道系数（常数项）
#define IvyParam_SHAr unity_SHAr
//float4 球谐函数 G 通道系数（常数项）
#define IvyParam_SHAg unity_SHAg
//float4 球谐函数 B 通道系数（常数项）
#define IvyParam_SHAb unity_SHAb
//float4 球谐函数 R 通道系数（线性项）
#define IvyParam_SHBr unity_SHBr
//float4 球谐函数 G 通道系数（线性项）
#define IvyParam_SHBg unity_SHBg
//float4 球谐函数 B 通道系数（线性项）
#define IvyParam_SHBb unity_SHBb
//float4 球谐函数系数（二次项）
#define IvyParam_SHC unity_SHC

//===[阴影]===

//float4 级联阴影分割半径的平方
#define IvyParam_ShadowSplitSqRadii unity_ShadowSplitSqRadii
//float4 光源阴影偏移
#define IvyParam_LightShadowBias unity_LightShadowBias
