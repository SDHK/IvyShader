...
Shader "Ivy/IvyObject"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            ZTest LEqual
            HLSLPROGRAM
            #define IvyArg_Color _Color
            #define IvyArg_Scale _Scale
        ...
        Pass
        {
            ...
            Blend Off
            HLSLPROGRAM
            #define IvyArg_MainTex    _MainTex
            #define IvyArg_MainTex_ST _MainTex_ST
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Blend Off
            HLSLPROGRAM
            #define IvySet_ShadowScreen               // 不透明物体使用屏幕空间阴影
            
            #define IvyArg_MainTex           Input_MainTex
            #define IvyArg_MainTex_ST        Input_MainTex_ST
            #define IvyArg_ColorMask         Input_ColorMask
            #define IvyArg_Color1            Input_Color1
            #define IvyArg_Color2            Input_Color2
            #define IvyArg_Color3            Input_Color3
            #define IvyArg_Color4            Input_Color4
            ...
            #define IvyArg_BaseRampColor1     Input_BaseRampColor1
            #define IvyArg_BaseRampThreshold1 Input_BaseRampThreshold1
            #define IvyArg_BaseRampSoftness1  Input_BaseRampSoftness1
            #define IvyArg_BaseRampColor2     Input_BaseRampColor2
            #define IvyArg_BaseRampThreshold2 Input_BaseRampThreshold2
            #define IvyArg_BaseRampSoftness2  Input_BaseRampSoftness2
            #define IvyArg_BaseRampColor3     Input_BaseRampColor3
            #define IvyArg_BaseRampThreshold3 Input_BaseRampThreshold3
            #define IvyArg_BaseRampSoftness3  Input_BaseRampSoftness3
            #define IvyArg_BaseRampColor4     Input_BaseRampColor4
            #define IvyArg_BaseRampDir        Input_BaseRampDir
            #define IvyArg_BaseRampEnable  Input_BaseRampEnable
            #define IvyArg_RimColor           Input_RimColor
            #define IvyArg_RimPower           Input_RimPower
            #define IvyArg_RimIntensity       Input_RimIntensity
            #define IvyArg_BackRimColor        Input_BackRimColor
            #define IvyArg_BackRimPower        Input_BackRimPower
            #define IvyArg_BackRimIntensity    Input_BackRimIntensity
            #define IvyArg_FixedRimPower       Input_FixedRimPower
            #define IvyArg_FixedRimIntensity   Input_FixedRimIntensity
